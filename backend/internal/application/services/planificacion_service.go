...
type PlanificacionService struct {
	...
	generarHandler     *cmdplanif.GenerarTurnosHandler
...
func NewPlanificacionService(
	...
	return &PlanificacionService{
		createHandler:      cmdplanif.NewCreatePlanificacionHandler(planifRepo),
		updateHandler:      cmdplanif.NewUpdatePlanificacionHandler(planifRepo),
		deleteHandler:      cmdplanif.NewDeletePlanificacionHandler(planifRepo, turnoRepo),
		...
		generarHandler:     cmdplanif.NewGenerarTurnosHandler(planifRepo, empRepo, turnoRepo),
...
func (s *PlanificacionService) Generar(ctx context.Context, planificacionID string) error {
	return s.generarHandler.Handle(ctx, planificacionID)
}
...
func (s *PlanificacionService) GetStaffingRequirements() []planificacion.DotacionItem {
	return planificacion.CalcularDotacion()
}

// Used by employee service for potential cross-module queries - keep these for compatibility
var _ ports.EmployeeRepository = nil
var _ employee.Employee = employee.Employee{}
